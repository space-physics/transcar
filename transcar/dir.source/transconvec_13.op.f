...
!-------MZ
     ...
     &   form='unformatted',access='direct',status='old',recl=4*2*ncol0)
...
!        Eest    =buffer(32)            Get this from DATCAR
      ...
      close(unfic_in_transcar)
        ...
        open(unfic_in_transcar,file='dir.input/'//gridfn,
     &    form='unformatted', access='direct',status='old',recl=longrec)
...
!-------MZ
     ...
     &   form='unformatted',access='direct',recl=longrec1, status='new')
...
! yes unknown because we write in pieces iteratively
      open(fid_temp,file=filetemps,
     & form='unformatted',access='direct',recl=longrec,status='unknown')
...
246    continue
     ...
     &   form='unformatted', access='direct',status='new',recl=longrec)
