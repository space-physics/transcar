...
c
        do ialt=1,indlim
          densneut(1,ialt)=Nn2(indlim+1-ialt)
          densneut(2,ialt)=No2(indlim+1-ialt)
          densneut(3,ialt)=No (indlim+1-ialt)
          densneut(4,ialt)=Nh (indlim+1-ialt)
...
c
         ...
         densneut(3,indlim+ialt-1)=d(2)        ! O
         densneut(4,indlim+ialt-1)=d(7)        ! H
