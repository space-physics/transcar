...
C ===============================================================       
       implicit none
       CHARACTER(*) FSPEC
       character(80) FILEIN,FILEIN1 
	!warning, this can cause chopped filenames for long path!
       Real,Intent(out) :: GH(*),erad
       Integer,Intent(out):: ier,nmax
       integer :: u,i ,n,m,mm,nn
       real :: g,h                                    
C ---------------------------------------------------------------       
...
c       FILEIN1=FILEIN
       ...
       OPEN (newunit=u, FILE=FILEIN1, STATUS='OLD',IOSTAT=IER, ERR=999)
       READ(u, *, IOSTAT=IER, ERR=999)                            
       READ(U, *, IOSTAT=IER, ERR=999) NMAX, ERAD                 
...
C ---------------------------------------------------------------       
      ...
      DO NN = 1, NMAX                                              
           DO MM = 0, NN                                            
              READ(U, *, IOSTAT=IER, ERR=999) N, M, G, H      
