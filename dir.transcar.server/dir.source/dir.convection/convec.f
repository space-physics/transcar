	...
	if (flgini) then
	open(56,file='trace_conv',form='formatted',status='unknown')
	flgini=.false.
	endif
...
c	print*,'sortie convec',longeo,latgeo
...
c        lon=datan2(sb,cb)*rad2deg
	...
	real*8 function cor_cnv(iyd,tu,kp,lonmlt,latmag,
     &				dlat,dlon,psi0)
...
999	continue
	...
	real*8 function potar(iyd,tu,kp,lonmlt,latmag,dlat,dlon,
     &				dtheta,psi0)
