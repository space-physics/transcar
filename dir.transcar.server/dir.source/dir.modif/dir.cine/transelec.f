c
        subroutine transelec(npt,iyd,UTsec,glat,glong,f107,
     .          ap,chi,Ne,Te,Tj,nb_alt,Nh,No,No2,Nn2,Nn,Tn,indlim,jpreci0,
     .          N_0,T_0,kiappel,z,Heat,Ph,Po,Po2,Pn2,Pn,
...
c	  It is called by the fluid transportation
 	    jpreci = jpreci0
